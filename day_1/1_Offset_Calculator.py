...
has_duplicate_frequency = False
duplicate_frequency = 0

while not has_duplicate_frequency:
    for offset in offsets:
        if not has_duplicate_frequency:
            current_offset += offset
            print("current offset: " + str(current_offset))
            if current_offset in frequencies_reached:
                has_duplicate_frequency = True
                duplicate_frequency = current_offset
            else:
                frequencies_reached.append(current_offset)
                print("appending value to list of visited offsets: " + str(current_offset))

print("First duplicate offset: " + str(duplicate_frequency))

# 490 Answer to first question (summing up offsets after one pass)
# 141060 First guess to 2nd question

# 70357 2nd guess to 2nd question
